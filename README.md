...
На данный момент отдаются ****plain text*-данные а не json как задумывалось*** сведений о системе, в будущем будут нормальные ответы от сервера и нормальная обработка на мобильном клиенте

### Базовый URL

- **Локальный сервер**: `http://localhost:8090`
